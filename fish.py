...
model_cfg = os.path.join(dir_script, f"yolo/yolo-fish-{yolo_size}.cfg")
model_weights = os.path.join(dir_script, f"yolo/yolo-fish-{yolo_size}.weights")
class_names = os.path.join(dir_script, "yolo/fish.names")
